...
function ShowAttendenceTable() {
    ...
    for (let i = 0; i <= attendence_data.length; i++) {
        ...
        tr.addEventListener('click', function(){
            window.open(`/admin/show_attendence?attendence_date=${attendence_date}&running_class_id=${attendence_data[i].class_id}`, "_self")
        })
...
async function GetAttendenceData() {
    let data_url = Complete_url('DataApi', '/get_attendence?request_for=AllClasses&attendence_date=' + attendence_date)
